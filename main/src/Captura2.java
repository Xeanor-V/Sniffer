...
public class Captura2 {
   ...
   private static String asString(final byte[] mac) {
    ...
    public void getDevices() {
        ...
        System.out.println("Ingresa el numero de la tarjeta que deseas utilizar: ");
    ...
    public void startDevice(int deviceSelected) {
        ...
        int snaplen = snpl * 1024;           // Capture all packets, no trucation
        int flags = Pcap.MODE_PROMISCUOUS; // capture all packets
        int timeout = tmout * 1000;           // 10 seconds in millis
        ...
        pcap.loop(numPaquetes, jpacketHandler, " ");
         ...
         */
        System.out.println("/**********************************/");
        System.out.println("Paquetes recibidos: "+ numPaquetes);
